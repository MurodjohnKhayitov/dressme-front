...
const BottomHeader = () => {
    return(
        <div className={`bottom w-full max-w-[1440px] md:px-[130px] mx-auto my-3 hidden md:block`}>
                ...
                <div className="flex items-center justify-between">
                    <button className="flex items-center bg-bgColor px-3 h-12 rounded mr-2 border-searchBgColor border">
                        ...
                        <span className="font-medium mr-[12.38px] text-sm">Clothing type</span>
                    ...
                    <div className="flex items-center justify-between bg-bgColor rounded border-searchBgColor border h-12">
                        ...
                        <label className="rounded-full w-6 h-6 bg-black cursor-pointer border border-solid mr-2 border-borderColorCard" htmlFor="Color1">
