...
const MediumHeader = () => {
  ...
  return (
        ...
        <div className=" max-w-[1440px] md:px-[130px] mx-auto px-4">
        
            {/* Starting Full Screen page section */}
            <div className="w-full flex items-center py-3 ">
                
                <div className="flex items-center ss:w-full md:w-fit justify-between md:justify-start border-gray-900">
                    ...
                    <div onClick={toggleHamburger} className={`flex items-center justify-center bg-bgColor border px-4 h-12 rounded cursor-pointer md:hidden`}>
                        ...
                        <div className={`${ !hamburgerMenu ? "hamburger flex flex-col ease-linear duration-500" : "left-[-500px] ease-linear duration-500" } top-[75px] left-0 fixed right-0 w-full bg-white z-10 h-full overflow-y-scroll ss:px-[15px] ll:flex-fit`}>
                    ...
                    {/* Logo section */}
                    <div className=" flex justify-center items-center rounded h-12 ss:bg-bgColor border border-searchBgColor ss:px-4 ls:px-9 ll:px-14 ss:w-fit md:bg-white md:px-0 md:border-none">
                        <img src={logo} alt="logo" />
                    </div>

                    {/* Weather section */}
                    <div className={`flex items-center ss:w-fit bg-bgColor px-4 h-12 border rounded cursor-pointer md:justify-center md:ml-16`}>
                    ...
                    {/* Searching section */}
                    <div className="search flex items-center justify-between rounded font-medium h-12 border border-searchBgColor md:border-transparent md:w-[528px] ss:hidden md:flex">
                        {/* Catalog section */}
                        <button className="items-center bg-catalogBg px-4 h-12 rounded-l cursor-pointer hidden md:flex">
                            <img src={catalog} alt="catalog" />
                            <span className="text-fullBlue px-[9.5px] font-medium">Catalog</span>
                        </button>
